...
CREATE TABLE IF NOT EXISTS `popcorndb`.`ClassSeats` (
  ...
  PRIMARY KEY (`SeatID`),
  INDEX `HallClassID_idx` (`HallClassID` ASC) VISIBLE,
  CONSTRAINT `ClassSeats-HallClassID`
    FOREIGN KEY (`HallClassID`)
    REFERENCES `popcorndb`.`HallClass` (`HallClassID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `popcorndb`.`MovieSchedule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `popcorndb`.`MovieSchedule` ;

CREATE TABLE IF NOT EXISTS `popcorndb`.`MovieSchedule` (
  ...
  INDEX `MovieID_idx` (`MovieID` ASC) VISIBLE,
  INDEX `ScheduleID_idx` (`ScheduleID` ASC) VISIBLE,
  CONSTRAINT `MovieSchedule-MovieID`
    FOREIGN KEY (`MovieID`)
    REFERENCES `popcorndb`.`Movies` (`MovieID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `MovieSchedule-ScheduleID`
    FOREIGN KEY (`ScheduleID`)
    REFERENCES `popcorndb`.`Schedule` (`ScheduleID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
